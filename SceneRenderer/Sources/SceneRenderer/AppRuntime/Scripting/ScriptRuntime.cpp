...
// InputSnapshot compares std::optional<std::array<...>> values; both standard
// library types must be declared in this module unit instead of inherited from imports.
#include <array>
#include <optional>
