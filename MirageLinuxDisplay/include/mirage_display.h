...
#define MIRAGE_DISPLAY_PROTOCOL_MINOR 3
...
enum {
    ...
    MD_FEATURE_TARGET_GPU_BINDING = UINT64_C(1) << 6,
};

enum {
    MD_TARGET_GPU_RENDER_NODE_VALID = UINT32_C(1) << 0,
    MD_TARGET_GPU_DEVICE_UUID_VALID = UINT32_C(1) << 1,
    MD_TARGET_GPU_DRIVER_UUID_VALID = UINT32_C(1) << 2,
};
