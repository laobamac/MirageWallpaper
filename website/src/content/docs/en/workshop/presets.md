...
3. After you confirm, automatically [download](/MirageWallpaper/en/workshop/download/) the required dependency.
...
- A preset's property overrides show up in the [Playback Controls and Custom Properties](/MirageWallpaper/en/wallpapers/playback/) panel, where you can still fine-tune on top of them.

For more detail on properties and the `dependency` / `preset` fields, see [project.json Structure](/MirageWallpaper/en/formats/project-json/).
