...
| Sort | Description |
| --- | --- |
| Trending | Content gaining traction recently (about 7 days) |
| Newest | By publish date, newest first |
| Most Subscribed | Highest cumulative subscriptions |
| Top Rated | Highest overall rating |

## Tag categories

The tag bar offers a rich set of categories, for example:

Anime, Nature, Abstract, Landscape, Sci-Fi, Cartoon, Cyberpunk, Fantasy, Girls, Game, Animal, Music, Vehicle, Technology, Retro, City, Space, Dark, Pixel, Minimalist, Underwater, Relaxing, Medieval, and more.

Selecting a tag shows only content in that category, and can be combined with sort and search.

## Search

The search bar supports finding Workshop items by keyword, and combined with tags it can narrow things down further.

## Pagination and loading

Results load in pages (about 30 items each); scroll or page through to load more. Preview thumbnails are cached, so repeated browsing is faster.
