...
- 复现步骤；
- 预期结果与实际现象；
- 相关日志（可在[通用设置](/MirageWallpaper/settings/general/)开启「详细日志」，创意工坊问题可导出脱敏的支持报告）。
...
构建方法见[从源码构建](/MirageWallpaper/advanced/build/)。

## 赞助

Mirage 会继续免费开放开发。如果它为你的桌面带来了价值，欢迎按自己的意愿赞助——每一份支持都会用于持续维护、兼容性改进和新功能开发。**赞助完全自愿，不影响任何功能使用。**

- 爱发电：<https://www.ifdian.net/a/laobamac>
- 微信支付 / 支付宝：见项目 [README](https://github.com/laobamac/MirageWallpaper) 中的二维码
- 海外用户可赞助 USDT（见 README）
