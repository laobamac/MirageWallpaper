...
详见 [Steam 登录](/workshop/login/)与 [SteamCMD](/workshop/steamcmd/)。
...
见 [Steam Web API Key](/workshop/api-key/)。
...
网页壁纸会执行 JavaScript，可能自行发起网络请求或加载远程资源。Mirage 因此对未信任的网页壁纸设有[安全确认](/settings/web-safety/)。请只信任来源可靠的网页壁纸。
...
你的壁纸、下载、缓存和设置都保存在本机。相关路径见[数据目录](/advanced/data-directories/)。你可以随时在访达中查看、备份或清理这些目录。
